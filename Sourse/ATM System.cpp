...
void PerfromQuickWithdrawOption(short QuickWithDrawOption)
{
	...
	vector <sClient> vClients = LoadCleintsDataFromFile(ClientsFileName);
	bool result = DepositBalanceToClientByAccountNumber(CurrentClient.AccountNumber, WithDrawBalance * -1, vClients);
...
void PerfromDepositOption()
{
	...
	vector <sClient> vClients = LoadCleintsDataFromFile(ClientsFileName);
	bool result = DepositBalanceToClientByAccountNumber(CurrentClient.AccountNumber, DepositAmount, vClients);
